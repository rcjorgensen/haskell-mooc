...
cull _ Empty = Empty
cull val (Node x l r) = if val /= x 
                        then Node x (cull val l) (cull val r) 
                        else Empty
...
isOrdered = isOrdered'
--isOrdered (Node x Empty (Node rx rl rr)) = x < rx && (isOrdered (Node rx rl rr))
--isOrdered (Node x (Node lx ll lr) (Node rx rl rr)) = lx < x && x < rx && (isOrdered (Node lx ll lr)) && (isOrdered (Node rx rl rr))
--isOrdered (Node x (Node lx ll lr) Empty) = lx < x && (isOrdered (Node lx ll lr))
