...
oddFactorial n
    | odd n     = oddFactorial' n 1
    | otherwise = oddFactorial (n-1)

oddFactorial' 1 result = result
oddFactorial' n result = oddFactorial' (n - 2) (n * result)
...
smallestDivisor' n result 
    | n `mod` result == 0 = result
    | otherwise           = smallestDivisor' n (result + 1)
